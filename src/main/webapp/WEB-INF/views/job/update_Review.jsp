                    ...
                    <!--메인 컨텐츠 영역/ 여길 수정하셔서 쓰시면 됩니당,,-->
                        <div class="container">
                            ...
                            <div class="eun_main_content">
                                <div class="eun_star">
                                    <h2>근무는 어떠셨나요?</h2>
                                    <form name="reviewform" class="reviewform" method="POST" action="${contextPath}/company/go_for_update_Review.do?review_num=${review_num}">
                                        <input type="hidden" name="rate" id="rate" value="0"/>
                                        <p class="title_star">별점과 이용후기를 남겨주세요</p>
