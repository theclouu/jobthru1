...
public class BoardControllerImpl  implements BoardController{
  ...
  //�븳 媛� �씠誘몄� �닔�젙 湲곕뒫
	 ...
	 * session.getAttribute("member"); String mid = memberVO.getId();
	 ...
	 * oldFile.delete(); } message = "<script>"; message +=
	 * " alert('湲��쓣 �닔�젙�뻽�뒿�땲�떎.');"; message +=
	 ...
	 * " alert('�삤瑜섍� 諛쒖깮�뻽�뒿�땲�떎.�떎�떆 �닔�젙�빐二쇱꽭�슂');"; message +=
	 * " location.href='"+multipartRequest.getContextPath()+
	 * "/board/viewArticle.do?articleNO="+articleNO+"';"; message +=" </script>";
	 * resEnt = new ResponseEntity(message, responseHeaders, HttpStatus.CREATED); }
	 * return resEnt; }
